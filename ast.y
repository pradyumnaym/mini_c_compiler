...
statement
	...
	| iteration_statement
	| control_statement_while
	| control_statement_if
	| control_statement_if_else
...
iteration_statement
	: 
	 FOR '(' expression_statement expression_statement ')' statement 				{ create_node("for",0); }
...
conditional_expression
	...
	| equality_expression '?' expression ':' conditional_expression	
			{
				create_node("con_else", 0);
				create_node("con_if", 0);
				if($1 == 1){
					$$ = $3;
